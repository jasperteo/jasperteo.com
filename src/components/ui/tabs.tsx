...
function TabsList({
	...
	return (
		...
		>
			{children}
			<TabsPrimitive.Indicator className="bg-background/70 dark:bg-popover dark:border-input absolute top-1/2 left-0 -z-10 h-7 w-[var(--active-tab-width)] translate-x-[var(--active-tab-left)] -translate-y-1/2 rounded-full border border-transparent shadow-sm transition-[width,translate] duration-300 ease-out" />
		</TabsPrimitive.List>
	);
}
